...
@CucumberOptions(features = "src/test/resources/features/login_colorlib.feature",
        tags = "@HistoriaDeUsuario",
        glue = {"co.com.choucair.certification.RETOCOLORLIB.stepdefinitions"},
        snippets = CucumberOptions.SnippetType.CAMELCASE)
public class RunnerColorlib {

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("src/test/resources/features/login_colorlib.feature");
    }
}
